...
const TO_EMAIL = process.argv[2] || "jlbender2005@gmail.com";
...
const unsubscribeUrl = `https://pathgen.dev/unsubscribe?email=${encodeURIComponent(TO_EMAIL)}`;
...
async function sendEmail() {
  try {
    console.log(`Sending PathGen v2 Announcement Email...`);
